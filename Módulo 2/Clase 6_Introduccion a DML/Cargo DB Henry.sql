...
-- #6 Como parte de un programa de actualización, 
-- el área de People le solicita un listado de los instructores que dictan la carrera de Full Stack Developer.
-- SELECT DISTINT trae solo valores unicos, no repetidos
...
-- a. ¿Que campos permiten que se puedan acceder al nombre de la carrera? Cohorte y luego Carrera
