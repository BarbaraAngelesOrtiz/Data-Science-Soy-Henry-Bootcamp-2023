...
En la presente clase abordaremos dos modelos predictivos para los problemas de clasificación del aprendizaje supervisado: `regresión logística`, `árboles de decisión` y `vecinos más cercanos.`
...
Recordando la fórmula para la regresión lineal múltiple tenemos que:


<img src="../_src/assets/Regresión_1.png"   
width="700px" height="350px">
</p>


El término "lineal" en los modelos de regresión hace referencia al hecho de que los parámetros se incorporan en la ecuación de forma lineal, no a que necesariamente la relación entre cada predictor y la variable respuesta tenga que seguir un patrón de recta. Ahora, si no queremos hacer una regresión sino una clasificación (es decir, nuestra variable objetivo se tratará como categoría), una adaptación del modelo de regresión lineal múltiple se puede utilizar: la regresión logística. 

<img src="../_src/assets/Regresión_Logística.png"   
width="500px" height="350px">
</p>


Como pueden notar en la imagen la variable objetivo es dicotómica (0 para ausencia y 1 para presencia). En este caso, se utiliza la función sigmoidal cuyo rango está dado entre 0 y 1. 

<img src="../_src/assets/Función_sigmoidal.png"   
width="500px" height="350px">
</p>

Al reemplazar en la función sigmoidal la ecuación de regresión lineal, nos queda:

<img src="../_src/assets/Regresión_Logística2.png"   
width="700px" height="350px">
</p>
...
<img src="../_src/assets/arbol_iris2.png" width="500px" height="500px">
</p>

A raíz de estas preguntas, las fronteras de decisión quedarían conformadas de la siguiente manera:

<img src="../_src/assets/arbol_iris.png" width="500px" height="350px">
</p>
...
### Al final de la Clase, profundizamos sobre la relación entre Entropía e Información...
...
Trabajaremos con datos y una afirmación muy común va a ser asociar a la Entropía con la pérdida de Información, pero esto, ¿por qué es así? Sabemos qué es la Información, pero… ¿qué es la Entropía realmente?<br>
La Entropía es la Segunda Ley de la Termodinámica, se encuentra en todos los procesos de la Naturaleza y no se requiere saber de Física ni fórmulas complejas para comprenderla, está basada en el sentido común:<br>
Imaginemos un gas dentro de una caja con un separador en el medio. Si se quita el separador, el gas se expande y ocupa toda la caja, pero ¿por qué esto es así? Y además, ¿por qué este fenómeno no es reversible?<br>
Ese hecho se explica simplemente con la Combinatoria, la Probabilidad y la Estadística.<br>
<img src="../_src/assets/entropia_01.png" height="150">
<br>
Recurramos a un ejemplo más sencillo:
Si se tiran dos dados y hubiera que apostar a la suma de ambos, ¿a qué número apostarías?
Empezamos por la combinatoria y verificamos que la suma 7 es la de mayor número de ocurrencias posibles dentro de 36 combinaciones.<br>
La suma 7 es el **estado inespecífico** con más configuraciones posibles, es decir, con más **estados específicos** posibles, ya que 6 combinaciones suman 7:<br>
...
|	12	|	1	|
<br>
<img src="../_src/assets/entropia_02.png" height="50">
<br>
Y si en lugar de 2 dados, usamos 3 o usamos 100 ¿como se transformaría esa distribución de probabilidad?<br>
Conforme el número de elementos aumenta, la distribución de la probabilidad se hace más marcada hacia su centro.<br>
<img src="../_src/assets/entropia_03.png" height="150"><br>
Entonces, si volvemos al ejemplo del gas, y tenemos en cuenta su cantidad de moléculas, ocupa toda la caja simplemente porque es su estado más probable.<br>
<img src="../_src/assets/entropia_04.png" height="150"><br>
La Entropía mide la probabilidad de encontrar un estado debido a su multiplicidad. Un estado con alta Entropía es un estado muy probable, porque se puede alcanzar de muchas formas posibles equivalentes. El Universo tiende a aumentar la Entropía.<br>
Entonces, **¿cuál es la relación con la Información?**<br>
Si vemos a ese gas como sólo 4 moléculas de 4 colores diferentes, y sabemos que su estado más probable serán repartidas en los 2 lados de la caja, debido a tendrá la mayor cantidad (6) de estados posibles para acomodarse.<br>
* ¿Exactamente dónde quedará cada una?
* Si todas están en un solo lado sabemos exactamente donde están, así que tenemos toda la información.
* Pero si no es así, nos falta información para saber de qué lado se quedará cada molécula.
* **El estado de máxima Entropía, que es precisamente aquél más probable, ¡implica la mayor pérdida de Información!**

<br> **Entropía**:
<br> “Un sistema aislado evoluciona siempre a un estado donde aumenta su información perdida.”
<br><img src="../_src/assets/entropia_05.png" height="100">
